...
public class BuildingOneSprites
{
    ...
    static{
        try {
            ...
            A2_1 = ImageIO.read(new File("Textures/Buildings/BuildingOne/1/A2_1.png"));

            A1_2 = ImageIO.read(new File("Textures/Buildings/BuildingOne/2/A1_2.png"));
            A2_2 = ImageIO.read(new File("Textures/Buildings/BuildingOne/2/A2_2.png"));

            A1_3 = ImageIO.read(new File("Textures/Buildings/BuildingOne/3/A1_3.png"));
            A2_3 = ImageIO.read(new File("Textures/Buildings/BuildingOne/3/A2_3.png"));

            A1_4 = ImageIO.read(new File("Textures/Buildings/BuildingOne/4/A1_4.png"));
            A2_4 = ImageIO.read(new File("Textures/Buildings/BuildingOne/4/A2_4.png"));

            A1_5 = ImageIO.read(new File("Textures/Buildings/BuildingOne/5/A1_5.png"));
            A2_5 = ImageIO.read(new File("Textures/Buildings/BuildingOne/5/A2_5.png"));

            A1_6 = ImageIO.read(new File("Textures/Buildings/BuildingOne/6/A1_6.png"));
            A2_6 = ImageIO.read(new File("Textures/Buildings/BuildingOne/6/A2_6.png"));

            A1_7 = ImageIO.read(new File("Textures/Buildings/BuildingOne/7/A1_7.png"));
            A2_7 = ImageIO.read(new File("Textures/Buildings/BuildingOne/7/A2_7.png"));

            A1_8 = ImageIO.read(new File("Textures/Buildings/BuildingOne/8/A1_8.png"));
            A2_8 = ImageIO.read(new File("Textures/Buildings/BuildingOne/8/A2_8.png"));
